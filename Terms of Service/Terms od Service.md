...
### 2. Age Eligibility
The App is not intended for use by individuals under the age of 13 (or 16 within the European Economic Area). By using the App, you represent and warrant that you meet the minimum age required by applicable law in your jurisdiction to form a binding contract, or that you have obtained parental/guardian consent where permitted.

---

### 3. Grant of License and Intellectual Property
Tomasz Rutkowski ("Developer") grants you a personal, non-exclusive, non-transferable, revocable license to use the App for personal, non-commercial purposes on your mobile device.

* **Prohibitions:** Commercial redistribution, sublicensing, or sale of the App or its integrated features is strictly prohibited.
* **Content Creation Permission:** You are explicitly permitted to use the App for non-commercial and commercial video content creation (e.g., streaming or recording gameplay analysis on YouTube, Twitch, or similar platforms).

---

### 4. User Conduct and API Usage
The App acts as a client interface and interacts directly with third-party APIs (**Chess.com** and **Lichess.org**). You agree to:
* Not use the App to harass, abuse, overload, or spam these third-party services.
* Not attempt to reverse engineer, decompile, disassemble, or derive the source code of the App.
* Comply fully with the Terms of Service and API policies of Chess.com and Lichess.org when accessing their platform data through the App.
* Not circumvent or attempt to bypass any rate limits, security measures, or restrictions imposed by the App or third-party API providers.

---

### 5. Service Availability and API Disruptions
The App relies strictly on third-party APIs (Chess.com and Lichess.org) to fetch chess games and player data. You acknowledge and agree that:
* If a third-party provider changes its API, restricts access, alters data formats, or ceases operations, certain or all features of the App may become unavailable.
* The Developer is not responsible or liable for any such third-party disruptions, modifications, or feature loss, and is not obligated to provide compensation or refunds in such events.
...
*NOTHING IN THESE TERMS SHALL AFFECT ANY STATUTORY RIGHTS THAT YOU ARE ALWAYS ENTITLED TO AS A CONSUMER UNDER APPLICABLE LOCAL LAWS THAT CANNOT BE WAIVED OR LIMITED BY CONTRACT.*
